...
float centerX, centerY, xStart, yStart, widthRect, heightRect, widthEllipse, heightEllipse;
color blackNightMode=#000000, yellow=#F8FC64, purple=#BEE3F0, white=#FFFFFF; 
...
void draw() {
  ...
  ellipse(xStart, yStart, widthEllipse, heightEllipse);
    stroke( yellow ); 
    fill( purple ); 
} //End draw
//
